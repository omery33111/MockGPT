              ...
              >
                <div className="flex min-h-[44px] items-center px-2">
                  <div className="max-w-full flex-1">
                    <div
                      className="_prosemirror-parent_15ceg_1 text-token-text-primary max-h-[25dvh] max-h-52 overflow-auto"
                      contentEditable
                      translate="no"
                      id="prompt-textarea"
                    ...
                    >
                      <input
                        className="block h-10 w-full resize-none border-0 focus:outline-none bg-transparent px-0 py-2 text-token-text-primary placeholder-[#3B3B3B] placeholder:translate-y-[-2px]"
                        autoFocus
