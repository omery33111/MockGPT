  ...
  return (
    <header className="w-full p-2 flex justify-between items-center absolute top-0 left-0">
      ...
      <div className="flex space-x-2 mr-[8px]">
        <button className="bg-black text-white w-[65.33px] py-1 rounded-[30px] text-sm whitespace-nowrap font-semibold enabled:hover:bg-[rgba(0,0,0,0.87)]">
          Log in
        </button>
        <button className="bg-white text-black w-[74.34px] py-1 rounded-[30px] border border-gray-300 text-sm whitespace-nowrap font-semibold hidden md:block enabled:hover:bg-[rgba(0,0,0,0.020)]">
          Sign up
        </button>
      </div>
    </header>
